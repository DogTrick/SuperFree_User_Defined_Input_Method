...
try:
    ...
    try:
        ...
        print("joblib installation done")
    except:
        print("joblib installation failed")
        print("Check connection status!")
    try:
        os.system("pip install numpy")
        print("numpy installation done")
    except:
        print("numpy installation failed")
        print("Check connection status!")
    try:
        os.system("pip install pandas")
        print("pandas installation done")
    except:
        print("pandas installation failed")
        print("Check connection status!")
    try:
        os.system("pip install flask")
        print("flask installation done")
    except:
        print("flask installation failed")
        print("Check connection status!")
    try:
        os.system("pip install opencv-python")
        print("opencv-python installation done")
    except:
        print("opencv-python installation failed")
        print("Check connection status!")
    try:
        os.system("pip install tensorflow")
        print("tensorflow installation done")
    except:
        print("tensorflow installation failed")
        print("Check connection status!")
    try:
        os.system("pip install matplotlib")
        print("matplotlib installation done")
    except:
